...
import com.food.jwt.JwtAuthorizationFilter;
import com.food.jwt.JwtTokenProvider;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.cors().and()
                ...
                .antMatchers("/resources/**","/api/admin/registration", "/error","/cart/**", "/api/user/**", "/restaurant/**","/food/**","/food/search/**","/order/**").permitAll()
                ...
                .formLogin().loginPage("/api/admin/login").and()
                .httpBasic().and()
